...
{\Huge \bfseries DESIGN TO DECEIVE}\\[0.4cm]

{\Large AI-Based Browser Extension for Real-Time Detection of Dark Patterns and Phishing Attacks Using RoBERTa-Based NLP Models}

\vspace{.5cm}

\includegraphics[width=0.3\textwidth]{National_Institute_of_Technology,_Srinagar_Logo.png}
...
{\Large \textbf{Information Technology and Engineering}}
...
\begin{tabular}{ll}
Musharaf Maqbool & (Roll No: 2022BITE053)\\
Mohammad Huzaif & (Roll No: 2022BITE047)\\
\end{tabular}

\vspace{1cm}

\text{Under the Guidance of}

\vspace{0.1cm}

\textbf{Dr. Shabir Ahmad Sofi}\\
Associate Professor\\
...
\vspace*{0.5cm}
\begin{center}
    \includegraphics[width=3.5cm]{National_Institute_of_Technology,_Srinagar_Logo.png} 
...
\noindent
This is to certify that the project titled \textbf{DESIGN TO DECEIVE: AI-Based Browser Extension for Real-Time Detection of Dark Patterns and Phishing Attacks Using RoBERTa-Based NLP Models} has been completed by \textbf{Musharaf Maqbool} (Roll No: 2022BITE053), \textbf{Gazi Mohammad Rayan Shah} (Roll No: 2022BITE049), and \textbf{Mohammad Huzaif} (Roll No: 2022BITE047) under my supervision in partial fulfillment of the requirements for the award of the degree of Bachelor of Technology in Computer Science and Engineering. It is also certified that the project has not been submitted or produced for the award of any other degree.
\end{onehalfspacing}
...
\begin{center}
    ...
    \vspace{1cm}
    \textbf{\Large STUDENT'S DECLARATION}
\end{center}

\vspace{1cm}
\begin{onehalfspacing}
\noindent
We, hereby declare that the work, which is being presented in the project entitled \textbf{DESIGN TO DECEIVE: AI-Based Browser Extension for Real-Time Detection of Dark Patterns and Phishing Attacks Using RoBERTa-Based NLP Models} in partial fulfillment of the requirements for the award of the degree of Bachelor of Technology in Computer Science and Engineering in the session 2025--2026, is an authentic record of our own work carried out under the supervision of Dr. Shabir Ahmad Sofi, Department of Computer Science and Engineering, National Institute of Technology Srinagar. The matter embodied in this project has not been submitted by us for the award of any other degree.
\end{onehalfspacing}

\vspace{2cm}
\noindent
\textbf{Dated:} \underline{\hspace{4cm}}

\vspace{2cm}
\noindent
\begin{minipage}[t]{0.45\textwidth}
(i) \textbf{Name:} Musharaf Maqbool\\
Roll No: 2022BITE053\\
\vspace{1cm}\\
...
\begin{onehalfspacing}
\noindent
We express our sincere gratitude to our project supervisor, Dr. Shabir Ahmad Sofi, for his valuable guidance, continuous encouragement, and technical insights throughout the development of this project.

\vspace{0.5cm}
\noindent
We would also like to thank the faculty members of the Department of Computer Science and Engineering, National Institute of Technology Srinagar, for providing us with the academic environment and resources necessary for carrying out this work successfully.

\vspace{0.5cm}
\noindent
Special thanks to our friends and colleagues who provided constructive suggestions during the implementation and testing phases of the project.

\vspace{0.5cm}
\noindent
Finally, we are deeply grateful to our families for their constant support and motivation throughout our academic journey.
\end{onehalfspacing}

\vspace{3cm}
\begin{flushright}
\textbf{Musharaf Maqbool}\\
\textbf{Mohammad Huzaif}
\end{flushright}
\clearpage
...
The rapid increase in deceptive web practices and phishing-based cyberattacks has significantly affected the security and decision-making capabilities of internet users. Modern websites increasingly employ manipulative user interface strategies, commonly known as dark patterns, to influence user behavior, while phishing attacks continue to exploit users through credential theft and fraudulent interactions.

This project presents ``DESIGN TO DECEIVE'', an AI-powered browser extension designed for real-time detection of dark patterns and phishing attacks using RoBERTa-based Natural Language Processing models. The proposed system integrates a Chrome browser extension with a FastAPI backend to analyze webpage elements dynamically during browsing sessions.

The extension continuously scans Document Object Model (DOM) elements, extracts textual content, and forwards suspicious elements to the backend inference engine through asynchronous message passing. The backend employs transformer-based RoBERTa models for semantic classification of manipulative patterns and phishing attempts.

Based on prediction confidence scores, the system highlights deceptive elements visually and provides contextual tooltip explanations to users in real time.

Additionally, the framework incorporates a cybersecurity-inspired dashboard interface capable of displaying risk scores, recent detections, phishing indicators, and dark pattern statistics.

Experimental evaluation indicates that the proposed system is capable of identifying various categories of dark patterns and phishing indicators with high confidence while maintaining real-time responsiveness suitable for modern web environments.

\vspace{0.5cm}
\textbf{Keywords:} Dark Patterns, Phishing Detection, Browser Extension, RoBERTa, Natural Language Processing, FastAPI, Cybersecurity, Real-Time Threat Detection.
...
The rapid evolution of the internet has transformed digital platforms into essential components of modern communication, commerce, education, and financial transactions. However, alongside these technological advancements, deceptive online practices have also increased significantly. Modern websites frequently employ manipulative interface strategies known as dark patterns, while cybercriminals continue to exploit phishing attacks to deceive users into revealing sensitive information.

Dark patterns are deceptive user interface techniques intentionally designed to manipulate user decisions. These patterns influence users into performing unintended actions such as subscribing to services, purchasing products, accepting unnecessary permissions, or sharing personal data. Similarly, phishing attacks exploit social engineering techniques to steal sensitive credentials including usernames, passwords, banking information, and authentication details.

Traditional browser security systems primarily focus on URL blacklisting and static rule-based detection approaches. While effective against previously known threats, these systems often fail to identify modern semantic manipulations and context-based deceptive techniques. As web interfaces become increasingly dynamic and psychologically manipulative, there is a growing need for intelligent detection systems capable of understanding human language and deceptive intent in real time.

This project proposes an AI-powered browser extension named ``DESIGN TO DECEIVE'' that combines Natural Language Processing, transformer-based RoBERTa models, real-time DOM analysis, and cybersecurity visualization techniques to identify deceptive content during live browsing sessions.
...
The rapid growth of e-commerce platforms, online services, and digital advertising has led to an increasing use of deceptive interface techniques commonly referred to as \textit{dark patterns}. These manipulative design practices intentionally influence users into making decisions that may not align with their interests. Simultaneously, phishing attacks continue to evolve, exploiting user trust through fraudulent interfaces and credential harvesting mechanisms.

Several research studies and industrial tools have attempted to address these cybersecurity and usability challenges through machine learning, browser-based protection systems, and natural language processing models.

This chapter presents a review of existing literature related to dark pattern detection, phishing identification, browser security extensions, and transformer-based NLP approaches.

\section{Dark Patterns in User Interfaces}
Dark patterns are deceptive user interface techniques designed to manipulate user behavior. These include urgency tactics, confirmshaming, hidden costs, forced continuity, and misleading button designs.

Narayanan et al. introduced one of the earliest large-scale taxonomies of dark patterns and highlighted their prevalence across e-commerce websites. Their work demonstrated how interface manipulation negatively affects user autonomy and informed consent.

\vspace{0.5cm}
\textbf{Key Findings:}
\begin{itemize}
\item Dark patterns influence impulsive decision-making.
\item Scarcity and urgency tactics are highly prevalent.
\item Existing detection systems rely heavily on manual analysis.
\end{itemize}

\section{Phishing Detection Techniques}
Phishing attacks aim to steal sensitive information such as passwords, banking credentials, and personal identification data through fraudulent interfaces and deceptive content.

Traditional phishing detection approaches relied on:
\begin{itemize}
\item URL analysis
\item Blacklisting
\item Heuristic rule-based systems
\end{itemize}
However, modern phishing attacks increasingly use sophisticated language patterns and realistic user interfaces, making traditional approaches less effective.

Recent studies have applied machine learning and deep learning methods for phishing classification using textual and contextual information.

\section{Transformer-Based NLP Models}
Transformer architectures such as BERT and RoBERTa have significantly improved performance in natural language understanding tasks.

RoBERTa (Robustly Optimized BERT Pretraining Approach) enhances the original BERT architecture through dynamic masking, larger training datasets, and improved optimization strategies. Due to its contextual language understanding capabilities, RoBERTa is highly effective in detecting manipulative language and phishing-related textual patterns.

\vspace{0.5cm}
\textbf{Advantages of RoBERTa:}
\begin{itemize}
\item Better contextual understanding
\item High classification accuracy
\item Strong performance on short interface text
\item Effective semantic analysis
\end{itemize}

\section{Browser Security Extensions}
Browser extensions provide real-time protection by monitoring webpage content dynamically during user interaction.

Existing browser security tools primarily focus on malicious URL blocking, advertisement filtering, and basic phishing warnings. However, most existing solutions fail to detect subtle dark patterns, provide contextual explanations, or perform real-time semantic analysis in a unified framework.

\section{Research Gap}
Based on the reviewed literature, several limitations remain in existing systems:
\begin{itemize}
\item Lack of unified detection for phishing and dark patterns.
\item Limited use of transformer-based NLP models in browser extensions.
\item Absence of real-time semantic analysis of webpage elements.
\item Poor visualization and explanation of detected threats.
\item High dependence on static heuristics and rule-based systems.
\end{itemize}
These limitations motivated the development of \textbf{Sentinel AI}, a real-time intelligent browser extension capable of detecting manipulative interfaces and phishing attacks using RoBERTa-based NLP models.
...
\hline
\textbf{System} & \textbf{Dark Pattern Detection} & \textbf{Phishing Detection} & \textbf{Real-Time Analysis} \\
\hline
Traditional URL Filters & No & Yes & Partial \\
\hline
Rule-Based Extensions & Partial & Partial & Yes \\
\hline
ML-Based Detection Systems & Partial & Yes & Partial \\
\hline
\textbf{Sentinel AI (Proposed)} & \textbf{Yes} & \textbf{Yes} & \textbf{Yes} \\
\hline
\end{tabular}
\end{table}

\section{Conclusion}
The literature survey demonstrates that although several approaches exist for phishing detection and browser security, very few systems address deceptive interface manipulation and phishing simultaneously. Furthermore, existing approaches lack contextual NLP-based analysis and interactive user-centric threat visualization. Sentinel AI addresses these limitations by integrating RoBERTa-based semantic analysis, real-time browser extension monitoring, and intelligent threat visualization into a unified cybersecurity framework.
